...
public static void main(String[] arg){
		...
		try{
			com.huiting.xml.activity.bean.RequestBean bean = new com.huiting.xml.activity.bean.RequestBean();
			bean.setSendTime(new Timestamp(System.currentTimeMillis()));
			bean.setUUID(UUID.randomUUID().toString());
			bean.setRequestType("C08");
			bean.setActivityDESC("desc");
			bean.setActivityName("name1");
			bean.setActivityType("01");
