...
public static void main(String[] arg){
		...
		try{ 
			com.huiting.xml.commenpublic.bean.RequestBean bean = new com.huiting.xml.commenpublic.bean.RequestBean();
			bean.setSendTime(new Timestamp(System.currentTimeMillis()));
			bean.setUUID(UUID.randomUUID().toString());
			bean.setRequestType("C05");
			bean.setBusiID("111");
			bean.setModular("01");
			bean.setCommentText("a啊啊啊");
			bean.setCommentTime(new Timestamp(System.currentTimeMillis()));
			bean.setConcernedNickName("哈哈");
			bean.setConcernedUserID("6127445");
			bean.setConcernedUserPicUrl("http://120.132.70.11:8080/huiting/files/6127445/test.png");
