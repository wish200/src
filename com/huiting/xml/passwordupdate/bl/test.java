...
public static void main(String[] arg){
		...
		try{ 
			 ...
			 * 后端校验旧密码正确性，更新密码。
			 */
			com.huiting.xml.passwordupdate.bean.RequestBean bean = new com.huiting.xml.passwordupdate.bean.RequestBean();
			bean.setSendTime(new Timestamp(System.currentTimeMillis()));
			bean.setUUID(UUID.randomUUID().toString());
			bean.setRequestType("A07");
			bean.setOldPassword("123456");
