...
public static void main(String[] arg){
		...
		try{
			com.huiting.xml.picbookdelete.bean.RequestBean bean = new com.huiting.xml.picbookdelete.bean.RequestBean();
			bean.setSendTime(new Timestamp(System.currentTimeMillis()));
			bean.setUUID(UUID.randomUUID().toString());
			bean.setRequestType("C01");
			bean.setPicbookID("PH2555677");
			bean.setPicbookName("");
