...
public static void main(String[] arg){
		...
		try{
			/*
			 * 用户关注，点击界面的关注
			 * 后台记录关注用户和被关注用户的信息，目前没吧图片地址放在接口中。
			 * 返回报文头
			 * 取消关注操作一致，只是后台状态更新为0.	
			 */
			com.huiting.xml.userconcerned.bean.RequestBean bean = new com.huiting.xml.userconcerned.bean.RequestBean();
			bean.setSendTime(new Timestamp(System.currentTimeMillis()));
			bean.setUUID(UUID.randomUUID().toString());
			
			bean.setRequestType("C03");
			//bean.setRequestType("C04");//取消关注
