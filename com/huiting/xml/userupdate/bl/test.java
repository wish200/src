...
public static void main(String[] arg){
		...
		try{
			...
			com.huiting.xml.userupdate.bean.RequestBean bean = new com.huiting.xml.userupdate.bean.RequestBean();
			bean.setSendTime(new Timestamp(System.currentTimeMillis()));
			bean.setUUID(UUID.randomUUID().toString());
			
			bean.setRequestType("A05");
			bean.setUserID("6127445");
			bean.setNickName("哈哈");
			bean.setBirthDay("1985-04-02");
			bean.setSex("1");
			bean.setRealName("zenghong");
			bean.setWeixin("zenghongzen");
			bean.setDescription("你是最棒的");
